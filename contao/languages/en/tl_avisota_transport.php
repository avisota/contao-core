...
$GLOBALS['TL_LANG']['tl_avisota_transport']['alias']       = array(
	'Alias',
...
$GLOBALS['TL_LANG']['tl_avisota_transport']['serviceName'] = array(
	'Service name',
 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_avisota_transport']['transport_legend'] = 'Transport module';
$GLOBALS['TL_LANG']['tl_avisota_transport']['sender_legend']    = 'Sender';
$GLOBALS['TL_LANG']['tl_avisota_transport']['reply_legend']     = 'Reply';
$GLOBALS['TL_LANG']['tl_avisota_transport']['swift_legend']     = 'Swift PHP Mailer';
$GLOBALS['TL_LANG']['tl_avisota_transport']['service_legend']     = 'Service';
...
$GLOBALS['TL_LANG']['tl_avisota_transport']['swiftSmtpSystemSettings'] = 'Use system settings';
$GLOBALS['TL_LANG']['tl_avisota_transport']['swiftSmtpOn']             = 'Send e-mails via SMTP';
$GLOBALS['TL_LANG']['tl_avisota_transport']['swiftSmtpOff']            = 'Send e-mails via PHP';
$GLOBALS['TL_LANG']['tl_avisota_transport']['service']                   = 'Custom service';
...
$GLOBALS['TL_LANG']['tl_avisota_transport']['delete'] = array(
