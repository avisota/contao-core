 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_avisota_newsletter_theme']['theme_legend']     = 'Theme';
$GLOBALS['TL_LANG']['tl_avisota_newsletter_theme']['structure_legend'] = 'Structure and content';
$GLOBALS['TL_LANG']['tl_avisota_newsletter_theme']['template_legend']  = 'Template settings';
$GLOBALS['TL_LANG']['tl_avisota_newsletter_theme']['expert_legend']    = 'Experts settings';


/**
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_avisota_newsletter_theme']['new']    = array(
	'New theme',
	'Create a new theme'
);
...
$GLOBALS['TL_LANG']['tl_avisota_newsletter_theme']['copy']   = array(
	'Duplicate theme',
	'Duplicate theme %s'
);
$GLOBALS['TL_LANG']['tl_avisota_newsletter_theme']['delete'] = array(
	'Delete theme',
	'Delete theme ID %s'
);
