...
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['integratedFilterByColumnsField']      = array('Column');
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['integratedFilterByColumnsComparator'] = array('Comparator');
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['integratedFilterByColumnsValue']      = array('Value');
...
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['memberFilterByColumnsField']            = array('Column');
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['memberFilterByColumnsComparator']       = array('Comparator');
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['memberFilterByColumnsValue']            = array('Value');
...
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['csvColumnAssignmentColumn'] = array('Column');
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['csvColumnAssignmentField']  = array('Assign');


/**
 * Legends
 */
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['source_legend']     = 'Recipient source';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['filter_legend']     = 'Filter settings';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['expert_legend']     = 'Experts settings';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['integrated_legend'] = 'Avisota integrated recipients';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['member_legend']     = 'Contao members';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['csvFile_legend']    = 'CSV file';


/**
 * Reference
 */
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['integrated'] = 'Avisota integrated recipients';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['member']     = 'Contao members';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['csv_file']   = 'CSV file';

$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['integrated_details']        = 'Avisota integrated recipients';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['member_details']            = 'Contao members';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['integrated_member_details'] = 'Avisota integrated recipients and Contao members';

$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['integratedByMailingLists']    = 'by selected mailing lists';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['integratedByAllMailingLists'] = 'by all mailing lists';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['integratedByRecipients']      = 'by recipients from selected mailing lists';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['integratedByAllRecipients']   = 'by all recipients';

$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['memberByMailingLists']       = 'by selected mailing lists';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['memberByAllMailingLists']    = 'by all mailing lists';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['memberByGroups']             = 'by selected groups';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['memberByAllGroups']          = 'by all groups';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['memberByMailingListMembers'] = 'by members from selected mailing lists';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['memberByGroupMembers']       = 'by members from selected groups';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['memberByAllMembers']         = 'by all members';

$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['duplicated_column']    = 'Columns and rows cannot used twice!';
$GLOBALS['TL_LANG']['tl_avisota_recipient_source']['missing_email_column'] = 'You need to assign email to one column!';
