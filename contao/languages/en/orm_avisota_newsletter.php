...
$GLOBALS['TL_LANG']['orm_avisota_newsletter']['description']   = array(
	'Description',
	'Please enter a short description for this newsletter.'
);
$GLOBALS['TL_LANG']['orm_avisota_newsletter']['keywords']      = array(
	'Keywords',
...
$GLOBALS['TL_LANG']['orm_avisota_newsletter']['meta_legend']       = 'Details';
$GLOBALS['TL_LANG']['orm_avisota_newsletter']['recipient_legend']  = 'Recipient';
$GLOBALS['TL_LANG']['orm_avisota_newsletter']['theme_legend']      = 'Theme settings';
$GLOBALS['TL_LANG']['orm_avisota_newsletter']['transport_legend']  = 'Transport settings';
