...
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['viewOnlinePage']   = array(
...
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['subscriptionPage'] = array(
...
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['senderName']       = array(
	'Sender Name ',
	'Here you can enter the name of the sender.'
);
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['sender']           = array(
	'Sender Address',
	'Here you can enter a customized return address.'
);
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['useSMTP']          = array(
	'Personal SMTP Server',
	'Use your own SMTP server to send the Newsletter.'
);
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['smtpHost']         = array(
	'SMTP Host Name ',
	'Please enter the host name of the SMTP server.'
);
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['smtpUser']         = array(
	'SMTP Username ',
	'Here you can enter the SMTP user name.'
);
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['smtpPass']         = array(
	'SMTP Password ',
	'Here you can enter the SMTP password.'
);
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['smtpEnc']          = array(
	'SMTP encryption ',
	'Here you can select an encryption method (SSL or TLS).'
);
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['smtpPort']         = array(
	'SMTP port number ',
...
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['areas']            = array(
	'Areas',
	'Comma separated list of additional content in the newsletter (e.a. header,left,right,footer).'
);
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['template_html']    = array(
	'HTML Email Template ',
	'Here you can select the HTML e-mail template.'
);
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['template_plain']   = array(
	'Plain text e-mail template ',
	'Here you can choose the Plain Text e-mail template.'
);
$GLOBALS['TL_LANG']['tl_avisota_newsletter_category']['stylesheets']      = array(
	'Style Sheets ',
