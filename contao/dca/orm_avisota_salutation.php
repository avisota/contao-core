...
(
	...
	(
		...
		(
			...
			'child_record_callback' => array('Avisota\Contao\DataContainer\Salutation', 'addElement')
		),
	...
	(
		...
		(
			...
			'exclude'          => true,
			'inputType'        => 'checkbox',
			'options_callback' => array('Avisota\Contao\DataContainer\OptionsBuilder', 'getRecipientFieldOptions'),
			'eval'             => array(
				'mandatory' => true,
				'multiple'  => true
			),
