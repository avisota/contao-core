...
$container['avisota.logger.handler'] = $container->share(
	function($container) {
...
$container['avisota.logger.handler.transport'] = $container->share(
	function($container) {
		...
		return $factory('avisota.transport.log', $container['avisota.logger.default.level']);
	}
);

$container['avisota.logger.transport.default.handlers'] = new ArrayObject(
...
$container['avisota.logger.transport'] = function($container) {
	...
	$logger = $factory('avisota.transport', $container['avisota.logger.transport.default.handlers']);
