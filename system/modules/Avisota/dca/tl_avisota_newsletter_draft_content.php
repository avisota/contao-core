...
(
	...
	(
		'invisible' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['invisible']
		),
		'type' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['type'],
			'default'                 => 'text',
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'select',
			'options_callback'        => array('tl_avisota_newsletter_draft_content', 'getNewsletterElements'),
			'reference'               => &$GLOBALS['TL_LANG']['NLE'],
			'eval'                    => array('helpwizard'=>true, 'submitOnChange'=>true, 'tl_class'=>'w50')
		),
		'area' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['area'],
			'default'                 => 'body',
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'select',
			'options_callback'        => array('tl_avisota_newsletter_draft_content', 'dcaGetNewsletterAreas'),
			'reference'               => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['area'],
			'eval'                    => array('mandatory'=>true, 'tl_class'=>'w50')
		),
		'headline' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['headline'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'inputUnit',
		...
		'text' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['text'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'textarea',
		...
		'definePlain' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['definePlain'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
		...
		'plain' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['plain'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'textarea',
		...
		'personalize' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['personalize'],
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'select',
			'options'                 => array('anonymous', 'private'),
			'reference'               => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content'],
			'eval'                    => array('tl_class'=>'long')
		),
		'addImage' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['addImage'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
			'eval'                    => array('submitOnChange'=>true)
		),
		'singleSRC' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['singleSRC'],
			'exclude'                 => true,
			'inputType'               => 'fileTree',
		...
		'alt' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['alt'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
		...
		'size' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['size'],
			'exclude'                 => true,
			'inputType'               => 'imageSize',
		...
		'imagemargin' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['imagemargin'],
			'exclude'                 => true,
			'inputType'               => 'trbl',
		...
		'imageUrl' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['imageUrl'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
			...
			'wizard' => array
			(
				array('tl_avisota_newsletter_draft_content', 'pagePicker')
			)
		),
		'caption' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['caption'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
		...
		'floating' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['floating'],
			'exclude'                 => true,
		...
		'listtype' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['listtype'],
			'exclude'                 => true,
			'inputType'               => 'select',
		...
		'listitems' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['listitems'],
			'exclude'                 => true,
		...
		'tableitems' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['tableitems'],
			'exclude'                 => true,
		...
		'summary' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['summary'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
		...
		'thead' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['thead'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
		...
		'tfoot' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['tfoot'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
			'eval'                    => array('tl_class'=>'w50')
		),
		...
		'linkTitle' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['linkTitle'],
			'exclude'                 => true,
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('maxlength'=>255, 'tl_class'=>'w50')
		...
		'embed' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['embed'],
			'exclude'                 => true,
			'inputType'               => 'text',
		...
		'multiSRC' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['multiSRC'],
			'exclude'                 => true,
			'inputType'               => 'fileTree',
		...
		'perRow' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['perRow'],
			'default'                 => 4,
			'exclude'                 => true,
			'inputType'               => 'select',
		...
		'sortBy' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['sortBy'],
			'exclude'                 => true,
			'inputType'               => 'select',
		...
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['galleryHtmlTpl'],
			'default'                 => 'nl_gallery_default_html',
			'exclude'                 => true,
			'inputType'               => 'select',
			'options_callback'        => array('tl_avisota_newsletter_draft_content', 'getGalleryTemplates'),
			'eval'                    => array('tl_class'=>'w50')
		),
		'galleryPlainTpl' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['galleryPlainTpl'],
		...
		'events' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['events'],
			'exclude'                 => true,
		...
		'protected' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['protected'],
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'checkbox',
			'eval'                    => array('submitOnChange'=>true)
		...
		'groups' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['groups'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
		...
		'guests' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['guests'],
			'exclude'                 => true,
			'filter'                  => true,
			'inputType'               => 'checkbox'
		),
		'cssID' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['cssID'],
			'exclude'                 => true,
			'inputType'               => 'text',
		...
		'space' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_avisota_newsletter_draft_content']['space'],
			'exclude'                 => true,
			'inputType'               => 'text',
...
class tl_avisota_newsletter_draft_content extends Avisota
{
...
' . $this->newsletter->getNewsletterElement(AvisotaRecipient::dummy(), $arrRow['id']) . '
	...
	public function toggleVisibility($intId, $blnVisible)
	{
		...
		$this->createInitialVersion('tl_avisota_newsletter_draft_content', $intId);

		// Trigger the save_callback
		if (is_array($GLOBALS['TL_DCA']['tl_avisota_newsletter_draft_content']['fields']['invisible']['save_callback']))
		{
			foreach ($GLOBALS['TL_DCA']['tl_avisota_newsletter_draft_content']['fields']['invisible']['save_callback'] as $callback)
			{
		...
		// Update the database
		$this->Database->prepare("UPDATE tl_avisota_newsletter_draft_content SET tstamp=". time() .", invisible='" . ($blnVisible ? '' : 1) . "' WHERE id=?")
					   ->execute($intId);

		$this->createNewVersion('tl_avisota_newsletter_draft_content', $intId);
	}
