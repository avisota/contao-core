...
&nbsp; :: &nbsp;
<a href="<?php echo TL_PATH ?>/contao/main.php?do=avisota_newsletter_draft&amp;table=tl_avisota_newsletter_draft&amp;act=edit&amp;id=<?php echo $this->id ?>" accesskey="e" title="<?php echo specialchars(sprintf($GLOBALS['TL_LANG']['tl_avisota_newsletter_draft']['editheader'][1], $this->id)) ?>" style="padding:2px 0 3px 18px; background:url('<?php echo TL_PATH ?>/system/themes/<?php echo $this->User->backendTheme ? $this->User->backendTheme : 'default' ?>/images/header.gif') no-repeat left center;"><?php echo $GLOBALS['TL_LANG']['tl_avisota_newsletter_draft']['editheader'][0] ?></a>
&nbsp; :: &nbsp;
<a href="<?php echo TL_PATH ?>/contao/main.php?do=avisota_newsletter_draft&amp;table=tl_avisota_newsletter_draft_content&amp;id=<?php echo $this->id ?>" accesskey="b" title="<?php echo specialchars(sprintf($GLOBALS['TL_LANG']['tl_avisota_newsletter_draft']['edit'][1], $this->id)) ?>" style="padding:2px 0 3px 16px; background:url('<?php echo TL_PATH ?>/system/themes/<?php echo $this->User->backendTheme ? $this->User->backendTheme : 'default' ?>/images/edit.gif') no-repeat left center;"><?php echo $GLOBALS['TL_LANG']['tl_avisota_newsletter_draft']['edit'][0] ?></a>
</div>
