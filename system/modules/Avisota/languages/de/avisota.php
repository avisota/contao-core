...
$GLOBALS['TL_LANG']['avisota']['subscription']['no_new']   = 'Sie sind bereits zu unserem Newsletter angemeldet.';
...
$GLOBALS['TL_LANG']['avisota']['subscribe']['mail']['confirm']     = 'Ihr Abonnent wurde erfolgreich aktiviert.';
