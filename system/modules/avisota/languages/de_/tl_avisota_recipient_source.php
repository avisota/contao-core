...
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['integratedFilterByColumnsField']      = array('Spalte');
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['integratedFilterByColumnsComparator'] = array('Vergleich');
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['integratedFilterByColumnsValue']      = array('Wert');
...
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['memberFilterByColumnsField']            = array('Spalte');
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['memberFilterByColumnsComparator']       = array('Vergleich');
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['memberFilterByColumnsValue']            = array('Wert');
...
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['csvColumnAssignmentColumn'] = array('Spalte');
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['csvColumnAssignmentField']  = array('Zuweisung');


/**
 * Legends
 */
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['source_legend']     = 'Abonnentenquelle';
...
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['integrated_legend'] = 'Integrierte Abonnenten';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['member_legend']     = 'Mitglieder';
 ...
 * Reference
 */
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['integrated']                  = 'Integrierte Abonnenten';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['member']                      = 'Mitglieder';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['csv_file']                    = 'Abonnenten aus CSV Datei';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['integrated_details']          = 'Integrierte Abonnenten';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['member_details']              = 'Mitglieder';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['integrated_member_details']   = 'Integrierte Abonnenten und Mitglieder';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['integratedByMailingLists']    = 'nach ausgewählten Mailingliste';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['integratedByAllMailingLists'] = 'nach allen Mailingliste';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['integratedByRecipients']      = 'nach Abonnenten aus ausgewählten Mailinglisten';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['integratedByAllRecipients']   = 'nach allen Abonnenten';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['memberByMailingLists']        = 'nach ausgewählten Mailingliste';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['memberByAllMailingLists']     = 'nach Mailingliste';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['memberByGroups']              = 'nach ausgewählten Mitgliedergruppen';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['memberByAllGroups']           = 'nach allen Mitgliedergruppen';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['memberByAllMembers']          = 'nach allen Mitgliedern';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['duplicated_column']           = 'Spalten und Felder dürfen nicht doppelt verwendet werden!';
$GLOBALS['TL_LANG']['orm_avisota_recipient_source']['missing_email_column']        = 'Sie müssen eine Spalte dem Feld E-Mail zuweisen!';
