	...
	public function hookLoadDataContainer($strName)
	{
		if ($strName == 'tl_stylepicker4ward') {
			...
			(
				...
				'inputType'        => 'checkbox',
				'options_callback' => array('AvisotaStylepickerDCA', 'getAvisotaNewsletterContentElements'),
				'load_callback'    => array(array('AvisotaStylepickerDCA', 'loadAvisotaNewsletterCEs')),
				'save_callback'    => array(array('AvisotaStylepickerDCA', 'saveAvisotaNewsletterCEs')),
			...
			(
				...
				'inputType'        => 'checkbox',
				'options_callback' => array('AvisotaStylepickerDCA', 'getAvisotaNewsletterSections'),
				'load_callback'    => array(array('AvisotaStylepickerDCA', 'loadAvisotaNewsletterCE_Rows')),
				'save_callback'    => array(array('AvisotaStylepickerDCA', 'doNothing')),
