...
/**
 * Class AvisotaBackendChartJqPlot
 *
 ...
 * @package    Avisota
 */
class AvisotaBackendChartJqPlot extends Backend implements AvisotaBackendChart
{
	/**
	...
	public function handleAjax(Database_Result $objNewsletter, $strRecipient)
	{
		...
		if ($this->Input->get('data')) {
			...
			{
				case 'sends':
					$this->Ajax->json_sends($objNewsletter, $strRecipient, false);

				case 'reads':
					$this->Ajax->json_reads($objNewsletter, $strRecipient, false);

				case 'reacts':
					$this->Ajax->json_reacts($objNewsletter, $strRecipient, false);

				case 'links':
					$this->Ajax->json_links($objNewsletter, $strRecipient, false);
			}
		}
	}
	...
	{
		$objTemplate = new BackendTemplate('be_avisota_chart_jqplot');
