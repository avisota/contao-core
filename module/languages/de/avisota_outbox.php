...
$GLOBALS['TL_LANG']['avisota_outbox']['col_open']              = 'öffnen';
$GLOBALS['TL_LANG']['avisota_outbox']['col_success']           = 'erfolgreich';
$GLOBALS['TL_LANG']['avisota_outbox']['col_timeout']           = 'Zeitüberschreitung';
$GLOBALS['TL_LANG']['avisota_outbox']['execute']               = 'Arbeite Warteschlange %s ab.';
